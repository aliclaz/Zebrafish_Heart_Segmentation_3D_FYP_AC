...
def build_atten_unet(backbone, skip_connection_layers, decoder_filters=(256, 128, 64, 32, 16), n_upsample_blocks=5, classes=1,
...
def AttentionUnet(backbone_name='vgg16', input_shape=(None, None, 3), classes=1, activation='sigmoid', weights=None,
                  encoder_weights='imagenet', encoder_freeze=False, encoder_features='default', decoder_filters=(256, 128, 64, 32, 16,),
                  decoder_use_batchnorm=True, dropout=None, **kwargs):
    ...
    model = build_atten_unet(backbone=backbone, skip_connection_layers=encoder_features, decoder_filters=decoder_filters, 
                             n_upsample_blocks=len(decoder_filters), classes=classes, activation=activation, 
                             use_batchnorm=decoder_use_batchnorm, dropout=dropout,)
